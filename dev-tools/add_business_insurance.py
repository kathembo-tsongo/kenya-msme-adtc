...
anchor = '''"utahitaji pia uthibitisho wa **KEBS** (Standardization Mark)."
    ),
}'''

new_content = '''"utahitaji pia uthibitisho wa **KEBS** (Standardization Mark)."
    ),
    "business_insurance": (
...
if count == 1:
    ...
    print("Added business_insurance canned answer")
