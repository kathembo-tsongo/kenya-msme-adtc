...
# No apostrophes anywhere below -- the digest lives inside a single-quoted
# Jinja string literal, so any apostrophe would terminate it early.
NEW_DIGEST_TAIL = (
    "Vuka loan up to KES 5,000,000 at 8% p.a.\\n"
    ...
    "arithmetic before stating a final figure. Never state a Shilling total that is not the direct "
...
assert "'" not in NEW_DIGEST_TAIL, "apostrophe found in inserted text -- fix before writing"
